...
public class ColorVisionResultActivity extends AppCompatActivity {

    private static final String TAG = "ColorVisionResult";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_color_vision_result);
        ...
        testManager.setColorVisionCompleted(true);
        testManager.setColorVisionScores(rightEyeScore, leftEyeScore);
    ...
    private void saveToDatabase() {
        ...
        // Test ID 3 = Color Vision Test
        apiManager.saveTestResult(profileId, 3, rightPercent, leftPercent, status,
    ...
    private void displayResults() {
        ...
        if (totalScore >= 9) {
            assessment = "Excellent! Your color vision appears to be normal with no signs of color deficiency.";
        } else if (totalScore >= 7) {
            assessment = "Good! Your color perception is mostly normal. Minor variations may be present.";
        } else if (totalScore >= 5) {
            assessment = "Fair. You may have mild color vision differences. Consider a professional evaluation.";
        } else {
            assessment = "We recommend consulting an eye care professional for a comprehensive color vision assessment.";
        }

...
public class NearVisionTestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_near_vision_test);
    ...
    private void setupClickListeners() {
        ...
        if (btnStartEye != null) {
            btnStartEye.setOnClickListener(v -> {
                Intent intent = new Intent(this, NearVisionQuestionActivity.class);

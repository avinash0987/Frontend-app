...
public class DistanceVisonTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_distance_vison_test);
    ...
    private void setupClickListeners() {
        ...
        if (btnStartEye != null) {
            btnStartEye.setOnClickListener(v -> {
                android.content.Intent intent = new android.content.Intent(this, DistanceVisionQuestionActivity.class);

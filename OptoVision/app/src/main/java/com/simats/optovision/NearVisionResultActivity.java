...
public class NearVisionResultActivity extends AppCompatActivity {

    private static final String TAG = "NearVisionResult";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_near_vision_result);
        ...
        testManager.setNearVisionCompleted(true);
        testManager.setNearVisionScores(rightEyeScore, leftEyeScore);
    ...
    private void saveToDatabase() {
        ...
        // Test ID 2 = Near Vision Test
        apiManager.saveTestResult(profileId, 2, rightPercent, leftPercent, status,
    ...
    private void displayResults() {
        ...
        if (totalScore >= 9) {
            assessment = "Excellent! Your near vision appears to be very good. Keep up great reading habits.";
        } else if (totalScore >= 7) {
            assessment = "Good! Your near vision is satisfactory. Consider regular reading breaks.";
        } else if (totalScore >= 5) {
            assessment = "Fair. You may want to consider an eye examination for reading vision.";
        } else {
    ...
    private void updateScoreColor(TextView textView, int score) {
        if (score >= 4) {
            textView.setTextColor(0xFF9C27B0); // Purple
        } else if (score >= 3) {
